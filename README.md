...
flowchart LR
    ...
    subgraph "/utils.jl"
        ...
        _utils_jl_unwrap_module["unwrap_module"]
    end
    ...
    _parse_jl_parse --> _utils_jl_unwrap_module
    ...
    _utils_jl_unwrap_module --> _utils_jl_get_children
    _utils_jl_unwrap_module --> _utils_jl_get_kind
```
